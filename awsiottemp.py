...
loopCount = 0
command_str = ''
topic = "RaspberryPi/SenseHatTemperature"
delay_s = 5
...
try:
	while True:
		...
		print(' Temperature: {} C , Pressure: {} Milibars , Humidity: {} , Loop # {:d}'.format(t,p,h,loopCount))
		print(' Time: {} \n'.format(timestamp))
		msg = '"Device": "{:s}", "Temperature": "{}","Pressure": "{}","Humidity": "{}", "Loop": "{}", "Time": "{}"'.format(sensor_sn, t,p,h,loopCount,timestamp)
		msg = '{'+msg+'}'
